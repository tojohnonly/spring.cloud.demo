package com.ensk.exp.consumer.feign.hystrix.controller;

import com.ensk.exp.consumer.feign.hystrix.client.UserClient;
...
public class HelloController {
    ...
    /**
     *
     * 对应上面的方法，参数必须一致，当访问失败时，hystrix直接回调用此方法,失败调用时，返回默认值
     */
